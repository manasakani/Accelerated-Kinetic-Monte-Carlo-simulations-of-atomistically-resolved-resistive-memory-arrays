...
//     // // copy back and print site_temperature
//     // double *site_temperature_h;
//     // gpuErrchk(cudaMallocHost((void**)&site_temperature_h, N * sizeof(double)));
//     // gpuErrchk(cudaMemcpy(site_temperature_h, site_temperature, N * sizeof(double), cudaMemcpyDeviceToHost));
//     // for (int i = 0; i < N; i++){
//     //     std::cout << setprecision(10) << "site_temperature_h[" << i << "]: " << site_temperature_h[i] << "\n";
//     // }
//     // exit(1);
