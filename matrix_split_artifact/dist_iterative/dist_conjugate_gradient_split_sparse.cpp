    ...
    MPI_Comm comm)
{
    ...
    cusparseDnVecDescr_t vecp_subblock = NULL;
    cusparseErrchk(cusparseCreateDnVec(&vecp_subblock, A_subblock.subblock_size, p_subblock_d, CUDA_R_64F));
    cusparseDnVecDescr_t vecAp_subblock = NULL;
    cusparseErrchk(cusparseCreateDnVec(&vecAp_subblock, A_subblock.count_subblock_h[A_distributed.rank], Ap_subblock_d, CUDA_R_64F));
    ...
    cusparseErrchk(cusparseDestroyDnVec(vecp_subblock));
    cudaErrchk(cudaFree(Ap_subblock_d));
    cusparseErrchk(cusparseDestroyDnVec(vecAp_subblock));
